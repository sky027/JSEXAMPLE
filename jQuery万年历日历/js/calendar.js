...
function mOck(thisObj, v,i){
	...
	if (type=="workday" || type=="seldaywork") {  //特殊工作日
		...
		if (onoff == "0") {
			dayJson += '1}';//添加修改数据
			thisObj.attributes["on"].value='1';
			document.getElementById("setworkday").innerHTML += "<span  class='date' id="+ymd+">"+ymd+"   "+"<img id='imgclick' value='"+ymd+"' onClick='imgonclick("+ymd+","+ids+","+lx+")' src='images/false.png'/></span>";//将内容加入框中
